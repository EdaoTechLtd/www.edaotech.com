...
function selectTab03Syn ( i )
{
	switch(i){
		...
		document.getElementById("font1").style.background="url(../images/edaoikey/tab-hover.png) left top no-repeat";
		...
		document.getElementById("font2").style.background="url(../images/edaoikey/tab-hover.png) left top no-repeat";
		document.getElementById("font3").style.background="none";
		document.getElementById("font4").style.background="none";
		break;
		case 3:
		...
		document.getElementById("font1").style.background="none";
		document.getElementById("font2").style.background="none";
		document.getElementById("font3").style.background="url(../images/edaoikey/tab-hover.png) left top no-repeat";
		document.getElementById("font4").style.background="none";
		break;
		case 4:
		document.getElementById("TabTab03Con1").style.display="none";
		...
		document.getElementById("font2").style.background="none";
		document.getElementById("font3").style.background="none";
		document.getElementById("font4").style.background="url(../images/edaoikey/tab-hover.png) left top no-repeat";
		break;
	}
}
